    ...
    <main class="bg-gray-200 p-1 h-[calc(100vh-100px)] overflow-scroll">
        <section class="bg-white w-9/12 h-3/5 mx-auto mt-20 p-6 rounded-lg">
            ...
            <div class="flex flex-row gap-2 h-3/5 mt-10">
                ...
                <a href="../search/" class="border-2 border-orange-700 rounded-md w-[50%] h-full flex gap-3 justify-center items-center text-orange-700 text-xl font-bold hover:bg-orange-700 hover:text-white">
                    <span>
