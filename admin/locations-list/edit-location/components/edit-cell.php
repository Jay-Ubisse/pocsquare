<div class="bg-white h-fit mx-auto p-6 rounded-lg laptop:mt-20 mobile:mt-20 laptop:w-fit mobile:w-[95%]">
    ...
    <form method="POST" action="" class="manual-form mt-10">
        <div class="grid laptop:grid-cols-2 mobile:grid-cols-1 gap-4">
            ...
            <div class="flex flex-col gap-2">
                <label for="admin-post" class="font-medium">Célula</label>
                <input type="text" name="admin-post" value="<?php echo $_SESSION["cell_name"] ?>" required autocomplete="off" class="input-field border border-orange-700 px-1 w-60 focus:outline-none outline-none rounded" />
            </div>
        </div>
