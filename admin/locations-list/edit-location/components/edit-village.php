    ...
    <form method="POST" action="../../../server/src/edit-location/edit-location.php" class="manual-form mt-10">
        <div class="grid laptop:grid-cols-2 mobile:grid-cols-1 gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <input type="text" name="village" value="<?php echo $_SESSION["village_name"] ?>" required autocomplete="off" class="input-field border border-orange-700 px-1 w-60 focus:outline-none outline-none rounded" />
            </div>
        </div>
