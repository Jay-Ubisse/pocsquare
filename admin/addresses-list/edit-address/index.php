...
?>
    ...
    <head>
        ...
        <title>Actualizar Endereço | Pocsquare</title>
    ...
    <body>
        ...
        <main class="h-screen">
            <form method="post" action="../../../server/src/update-address.php" class="border-2 border-orange-700 rounded-xl mx-auto mt-10 mb-20 laptop:w-[90%] mobile:w-[95%]">
                <h1 class="w-fit mx-auto my-5 font-bold text-2xl text-orange-700">Actualizar Endereço</h1>
                <?php
                ...
                <fieldset class="border border-orange-700 mx-auto rounded-md flex flex-col flex-wrap justify-evenly py-5 my-5 laptop:w-[97%] mobile:w-[90%]">
                    ...
                    <div class="flex laptop:flex-row mobile:flex-col laptop:justify-evenly laptop:gap-0 mobile:gap-2">
                        ...
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            ...
                            <input type="text" name="floor" value="<?php echo $_SESSION["floor"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="side" class="font-medium">Lado</label>
                            <input type="text" name="side" value="<?php echo $_SESSION["side"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="door-number" class="font-medium">Número da Porta</label>
                            <input type="number" min="1" name="door-number" value="<?php echo $_SESSION["door_number"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                    </div>
                    <div class="flex mt-2 laptop:flex-row mobile:flex-col laptop:justify-evenly laptop:gap-0 mobile:gap-2">
                        ...
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            ...
                            <input type="text" name="road-name" value="<?php echo $_SESSION["road_name"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="stalemate" class="font-medium">Impasse</label>
                            <input type="text" name="stalemate" value="<?php echo $_SESSION["stalemate"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="viaduct" class="font-medium">Viaduto</label>
                            <input type="text" name="viaduct" value="<?php echo $_SESSION["viaduct"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                    </div>
                    <div class="flex mt-2 laptop:flex-row mobile:flex-col laptop:justify-evenly laptop:gap-0 mobile:gap-2">
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="block" class="font-medium">Quadra</label>
                            <input type="text" name="block" value="<?php echo $_SESSION["block"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="roundabout" class="font-medium">Rotunda</label>
                            <input type="text" name="roundabout" value="<?php echo $_SESSION["roundabout"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="lane" class="font-medium">Travessas</label>
                            <input type="text" name="lane" value="<?php echo $_SESSION["lane"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="wide" class="font-medium">Largos</label>
                            <input type="text" name="wide" value="<?php echo $_SESSION["wide"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="bridges" class="font-medium">Pontes</label>
                            <input type="text" name="bridges" value="<?php echo $_SESSION["bridges"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                    </div>
                    <div class="flex mt-4 laptop:flex-row mobile:flex-col laptop:justify-evenly laptop:gap-0 mobile:gap-2">
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            ...
                            <input type="text" name="plaza" value="<?php echo $_SESSION["plaza"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="length" class="font-medium">Comprimento (metros)</label>
                            <input type="number" name="length" value="<?php echo $_SESSION["length"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="width" class="font-medium">Largura (metros)</label>
                            <input type="number" name="width" value="<?php echo $_SESSION["width"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="occupancy" class="font-medium">Ocupação</label>
                            <input type="text" name="occupancy" value="<?php echo $_SESSION["occupancy"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                        <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                            <label for="affectation" class="font-medium">Afetação</label>
                            <input type="text" name="affectation" value="<?php echo $_SESSION["affectation"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                        </div>
                    </div>
                </fieldset>
                <fieldset class="border border-orange-700 mx-auto rounded-md flex flex-row flex-wrap justify-evenly py-5 my-5 laptop:flex-row mobile:flex-col laptop:w-[97%] mobile:w-[90%]">
                    ...
                    <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                        ...
                        <input type="number" name="city-block" min="1" value="<?php echo $_SESSION["city_block"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                    </div>
                    <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                    ...
                    <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                        ...
                        <input type="text" name="mailbox" value="<?php echo $_SESSION["mailbox"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                    </div>
                    <div class="flex flex-col gap-2 laptop:w-[19%] mobile:w-full mobile:px-5 laptop:mb-0 mobile:mb-4">
                        <label for="post-office" class="font-medium">Estacão de correios</label>
                        <input type="text" name="post-office" value="<?php echo $_SESSION["post_office"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded">
                    </div>
                </fieldset>
                <fieldset class="border border-orange-700 mx-auto rounded-md gap-4 py-5 my-5 laptop:flex-row mobile:flex-col laptop:w-[97%] mobile:w-[90%]">
                    ...
                    <div class="flex justify-evenly w-full mobile:px-5 laptop:mb-0 mobile:mb-2 laptop:flex-row mobile:flex-col">
                        <div class="flex flex-col gap-2 laptop:mb-0 mobile:mb-4">
                            ...
                            <input type="text" name="latitude" placeholder="(Decimal Degrees)" value="<?php echo $_SESSION["latitude"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded px-2">
                        </div>
                        <div class="flex flex-col gap-2 laptop:mb-0 mobile:mb-4">
                            <label for="latitude-dms" class="font-medium">Latitude DMS</label>
                            <input type="text" name="latitude-dms" placeholder="(Degrees, Minutes, Seconds)" value="<?php echo $_SESSION["latitude_dms"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded px-2">
                        </div>
                        <div class="flex flex-col gap-2 laptop:mb-0 mobile:mb-4">
                            <label for="longitude" class="font-medium">Longetude</label>
                            <input type="text" name="longitude" placeholder="(Decimal Degrees)" value="<?php echo $_SESSION["longitude"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded px-2">
                        </div>
                        <div class="flex flex-col gap-2 laptop:mb-0 mobile:mb-4">
                            <label for="longitude-dms" class="font-medium">Longitude DMS</label>
                            <input type="text" name="longitude-dms" placeholder="(Degrees, Minutes, Seconds)" value="<?php echo $_SESSION["longitude_dms"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded px-2">
                        </div>
                    </div>
                    <div class="flex justify-evenly w-full mobile:px-5 laptop:mb-0 mobile:mb-4 laptop:flex-row mobile:flex-col laptop:mt-4">
                        <div class="flex flex-col gap-2 laptop:mb-0 mobile:mb-4">
                            ...
                            <input type="text" name="sea-​​rise" value="<?php echo $_SESSION["sea_rise"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded px-2">
                        </div>
                        <div class="flex flex-col gap-2 laptop:mb-0 mobile:mb-4">
                            <label for="via-lat-start" class="font-medium">Via Lat Start</label>
                            <input type="text" name="via-lat-start" value="<?php echo $_SESSION["via_lat_start"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded px-2">
                        </div>
                        <div class="flex flex-col gap-2 laptop:mb-0 mobile:mb-4">
                            <label for="via-lat-end" class="font-medium">Via Lat End</label>
                            <input type="text" name="via-lat-end" value="<?php echo $_SESSION["via_lat_end"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded px-2">
                        </div>
                    ...
                    <div class="flex justify-evenly w-full mobile:px-5 laptop:mb-0 mobile:mb-2 laptop:flex-row mobile:flex-col">
                        <div class="flex flex-col gap-2 laptop:mb-0 mobile:mb-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="contact-number" value="<?php echo $_SESSION["contact_number"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded px-2">
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 laptop:mb-0 mobile:mb-4">
                            <label for="email" class="font-medium">Email</label>
                            <input type="email" name="email" value="<?php echo $_SESSION["email"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded px-2">
                        </div>
                        <div class="flex flex-col gap-2 laptop:mb-0 mobile:mb-4">
                            <label for="website" class="font-medium">Website</label>
                            <input type="url" name="website" value="<?php echo $_SESSION["website"];  ?>" class="border border-orange-700 focus:outline-none outline-none rounded px-2">
                        </div>
                    </div>
                </fieldset>
                <div class="ml-5">
                ...
                <div class="flex flex-row gap-5 w-fit mx-auto my-10">
                    <input type="submit" value="Actualizar" class="bg-green-700 rounded-md text-white font-medium px-4 py-2">
