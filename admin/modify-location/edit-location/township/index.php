            ...
            <form method="POST" action="../../../../server/src/add-location/add-location.php" class="mt-10">
                <div class="flex laptop:flex-row  mobile:flex-col laptop:gap-0 mobile:gap-4 laptop:justify-around">
                    ...
                    <div>
                        ...
                        <input type="text" name="township" placeholder="Introduza o nome da povoação" required autocomplete="off" class="border border-orange-700 px-2 w-60 focus:outline-none outline-none rounded">
                    </div>
                </div>
