<section class="bg-white h-fit mx-auto mt-20 p-6 rounded-lg laptop:w-9/12 mobile:w-[95%]">
    ...
    <div class="flex gap-2 h-44 laptop:flex-row mobile:flex-col laptop:mt-10 mobile:mt-2">
        ...
        <a href="../../server/src/statistic.php" class="border-2 border-orange-700 rounded-md h-full flex gap-3 justify-center items-center text-orange-700 text-xl font-bold hover:bg-orange-700 hover:text-white laptop:w-[50%] mobile:w-full">
            <span>
