    ...
    <body>
        ...
        <script>
            ...
            $(".manual-form").submit(function(event) {
                ...
                switch (region) {
                    case "district":
                        $.post("../../server/src/add-location/add-district.php", {
                                inputRegion: region,
                                ...
                                regionOne: $(".districtOne").val(),
                                regionTwo: $(".districtTwo").val(),
                                regionThree: $(".districtThree").val(),
                                regionFour: $(".districtFour").val(),
                                regionFive: $(".districtFive").val(),
                                regionSix: $(".districtSix").val(),
                                regionSeven: $(".districtSeven").val(),
                                regionEight: $(".districtEight").val(),
                                regionNine: $(".districtNine").val(),
                                regionTen: $(".districtTen").val(),
                    ...
                    ${linesSkipped} linhas já existentes.`;
                        ...
                        break;
                    case "admin_post":
                        $.post("../../server/src/add-location/add-admin-post.php", {
                                inputRegion: region,
                                ...
                                districtOne: $(".districtOne").val(),
                                districtTwo: $(".districtTwo").val(),
                                districtThree: $(".districtThree").val(),
                                districtFour: $(".districtFour").val(),
                                districtFive: $(".districtFive").val(),
                                districtSix: $(".districtSix").val(),
                                districtSeven: $(".districtSeven").val(),
                                districtEight: $(".districtEight").val(),
                                districtNine: $(".districtNine").val(),
                                districtTen: $(".districtTen").val(),

                                adminPostOne: $(".adminPostOne").val(),
                                adminPostTwo: $(".adminPostTwo").val(),
                                adminPostThree: $(".adminPostThree").val(),
                                adminPostFour: $(".adminPostFour").val(),
                                adminPostFive: $(".adminPostFive").val(),
                                adminPostSix: $(".adminPostSix").val(),
                                adminPostSeven: $(".adminPostSeven").val(),
                                adminPostEight: $(".adminPostEight").val(),
                                adminPostNine: $(".adminPostNine").val(),
                                adminPostTen: $(".adminPostTen").val(),
                    ...
                    ${linesSkipped} linhas já existentes.`;
                        ...
                        break;
                    case "neighborhood_locality":
                        $.post("../../server/src/add-location/add-neighborhood-locality.php", {
                                inputRegion: region,
                                ...
                                localityOne: $(".localityOne").val(),
                                localityTwo: $(".localityTwo").val(),
                                localityThree: $(".localityThree").val(),
                                localityFour: $(".localityFour").val(),
                                localityFive: $(".localityFive").val(),
                                localitySix: $(".localitySix").val(),
                                localitySeven: $(".localitySeven").val(),
                                localityEight: $(".localityEight").val(),
                                localityNine: $(".localityNine").val(),
                                localityTen: $(".localityTen").val(),
                    ...
                    ${linesSkipped} linhas já existentes.`;
                        ...
                        break;
                    case "cell":
                        $.post("../../server/src/add-location/add-circle-cell-village-zone-township.php", {
                                inputRegion: region,
                                ...
                                regionOne: $(".regionOne").val(),
                                regionTwo: $(".regionTwo").val(),
                                regionThree: $(".regionThree").val(),
                                regionFour: $(".regionFour").val(),
                                regionFive: $(".regionFive").val(),
                                regionSix: $(".regionSix").val(),
                                regionSeven: $(".regionSeven").val(),
                                regionEight: $(".regionEight").val(),
                                regionNine: $(".regionNine").val(),
                                regionTen: $(".regionTen").val(),
