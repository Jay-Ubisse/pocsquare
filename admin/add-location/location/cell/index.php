...
<head>
    ...
    <title>Adicionar Célula | Pocsquare</title>
...
<body>
    ...
    <main class="bg-gray-200 p-1 h-[calc(100vh-100px)] overflow-scroll">
        <section class="bg-white h-fit mx-auto p-6 rounded-lg laptop:my-40 mobile:mt-20 laptop:w-1/2 mobile:w-[95%]">
            <h1 class="text-orange-700 text-xl font-semibold border-b border-orange-700 w-fit">Adicionar Célula</h1>
				<?php
				...
				?>
            <form method="POST" action="../../../../server/src/add-location/cell.php" class="mt-10">
                <div class="flex laptop:flex-row  mobile:flex-col laptop:gap-0 mobile:gap-4 laptop:justify-around">
                    ...
                    <div>
                        ...
                        <input type="text" name="cell" placeholder="Introduza o nome da localidade" required autocomplete="off" class="border border-orange-700 px-2 w-60 focus:outline-none outline-none rounded">
                    </div>
                </div>
