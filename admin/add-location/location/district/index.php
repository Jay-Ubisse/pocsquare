...
<body>
    ...
    <main class="bg-gray-200 p-1 h-[calc(100vh-100px)] overflow-scroll">
        <section class="bg-white w-1/2 h-fit mx-auto my-40 p-6 rounded-lg">
            <h1 class="text-orange-700 text-xl font-semibold border-b border-orange-700 w-fit">Adicionar Distrito</h1>
				<?php
					if(isset($_SESSION['add-province']) ) {
                        if($_SESSION['error']) {
                            echo "<div class='bg-red-600 text-white font-semibold flex justify-center my-6 py-4'>";
						    echo $_SESSION['add-province'];
						    unset($_SESSION['add-province']);
                ...
                <div class="flex flex-row justify-around">
                    <div>
                        ...
                        <select name="province" class="border border-orange-700 focus:outline-none outline-none rounded">
                            <option value="Maputo Província">Maputo Cidade</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="district" placeholder="Introduza o nome do distrito" required autocomplete="off" class="border border-orange-700 px-2 w-60 focus:outline-none outline-none rounded">
                    </div>
                </div>
