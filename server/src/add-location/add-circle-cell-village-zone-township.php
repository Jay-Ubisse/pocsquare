...
if (($_POST['districtOne'] != null) && ($_POST['idOne'] != null)) {
    ...
    selectProvince($inputRegion, $province, $id, $district, $adminPost, $locality, $regionName);
}
...
function selectProvince($inputRegion, $province, $id, $district, $adminPost, $locality, $regionName) {
    ...
    switch ($province) {
        case 'Maputo Cidade':
            ...
            if($isFound == "true") {
                ...
                saveLocation($table, $inputRegion, $district, $id, $adminPost, $locality, $regionName);
            }
            break;
...
function saveLocation($table, $inputRegion, $district, $id, $adminPost, $locality, $regionName) {
    ...
    try {
        ...
        $saveLocalityQuery = "INSERT INTO $database_name." . $table . " (id, province, district, admin_post, neighborhood_locality, " . $column . ") VALUES (?, ?, ?, ?, ?, ?)";
        $stmt = $dbcon->prepare($saveLocalityQuery);
        $stmt->execute([$id, $province, $district, $adminPost, $locality, $regionName]);
